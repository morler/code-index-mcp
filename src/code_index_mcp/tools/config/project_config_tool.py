    ...
    def load_existing_index(self) -> Dict[str, Any]:
        ...
        return {
            "symbols": [
                ...
                {"name": "another_function", "type": "function", "file_path": "test.py"},
                ...
                {"name": "process_function", "type": "function", "file_path": "test.py"},
                ...
                {"name": "AnotherInterface", "type": "interface", "file_path": "types.ts"},
                {"name": "AnotherClass", "type": "class", "file_path": "types.ts"},
                {"name": "anotherFunction", "type": "function", "file_path": "types.ts"},
